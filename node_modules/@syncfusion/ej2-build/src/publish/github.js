 ...
 */
gulp.task('publish-github-source', ['publish-coverage'], function (done) {
    ...
    var gitPath = 'https://' + user + ':' + token + '@gitlab.syncfusion.com/essential-studio/ej2-' + platform + 'github-source';
        ...
        gulp.src(config.github, {
            ...
            .on('end', function () {
                ...
                var githubRepo = 'https://' + user + ':' + token +
                    '@gitlab.syncfusion.com/essential-studio/ej2-' + platform + 'github-source.git';
