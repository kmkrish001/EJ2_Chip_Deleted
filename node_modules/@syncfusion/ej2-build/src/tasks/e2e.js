...
gulp.task('unzip-testreport', function () {
...
gulp.task('e2e-ci-test', function (done) {
    fs.access('./e2e/tests', fs.constants.F_OK, function (error) {
        if (error) {
            ...
            runSequence('unzip-testreport', 'e2e-scripts', 'e2e-tests', done);
        }
    });
});
...
//e2e helper script compilation
gulp.task('e2e-helper-scripts', function (done) {
    var tsConfigs = {
        module: 'commonjs',
        target: 'es6',
        types: ['jasmine', 'node']
